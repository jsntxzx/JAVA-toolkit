...
<div class="part-all gray-li">
	<div class="customer  am-container-1">
		...
		<div class="am-slider am-slider-default am-slider-carousel part-all"
			...
			<ul class="am-slides">
				<li><img src='<c:url value="/static/image/portal/ptn4.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn5.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn6.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn7.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn8.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn4.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn5.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn6.png"/>' /></li>
				<li><img src='<c:url value="/static/image/portal/ptn7.png"/>' /></li>
